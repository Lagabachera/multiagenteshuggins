        ...
        "tasks": [
            {
                "label": "Lint and Fix",
                "type": "shell",
                "command": f"./{virtual_env_name}/bin/flake8 ${{workspaceFolder}} && ./{virtual_env_name}/bin/autopep8 --in-place --aggressive --aggressive ${{workspaceFolder}}/*.py && ./{virtual_env_name}/bin/black ${{workspaceFolder}}",
                "group": {
                    "kind": "build",
                    "isDefault": True
                },
